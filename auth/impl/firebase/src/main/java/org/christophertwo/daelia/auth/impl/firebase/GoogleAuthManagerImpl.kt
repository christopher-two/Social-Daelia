package org.christophertwo.daelia.auth.impl.firebase
...
import org.christophertwo.daelia.auth.api.ExternalAuthResult
import org.christophertwo.daelia.auth.api.GoogleAuthManager
import org.christophertwo.daelia.auth.impl.firebase.GoogleAuthManagerImpl.Companion.WEB_ID
 ...
 *
 * @property context El contexto de la aplicación, necesario para inicializar [com.google.android.gms.auth.api.signin.GoogleSignInClient].
 */
class GoogleAuthManagerImpl(
    ...
    companion object {
        ...
        private const val WEB_ID =
            "389785265589-ld1nnu8dmmdh21t8fv3t89rjp5q8d3ol.apps.googleusercontent.com"
    }
     ...
     *
     * Utiliza [com.google.android.gms.auth.api.signin.GoogleSignInOptions.DEFAULT_SIGN_IN] como base y luego añade:
     ...
     *   del usuario.
     *
     * Luego, se obtiene el [com.google.android.gms.auth.api.signin.GoogleSignInClient] usando el [context] de la aplicación y las
     ...
     * @return Result.success con el [com.google.firebase.auth.AuthResult] de Firebase.
     * @return Result.failure con la [com.google.android.gms.common.api.ApiException] si hubo un error.
     */
